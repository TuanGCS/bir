...
#nftest_regwrite(0x76800000,0);
nftest_regwrite(0x76802000,1);
nftest_regwrite(0x76802004,2);
nftest_regwrite(0x76802008,3);
nftest_regwrite(0x7680200C,4);
nftest_regwrite(0x76802010,2);  # Write to this Address of this Table  
# Prepare acknowledgement on the Table Interface 
#nftest_regwrite(0x76803000,2);
#nftest_regwrite(0x76804000,3);
